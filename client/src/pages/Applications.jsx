...
const Applications = () => {
  ...
  return (
    ...
    <div className='container px-4 min-h-[65vh] 2xl:px-20 mx-auto my-10'>
        ...
        <div className='flex gap-2 mb-6 mt-3'>
            {
                ...
                <button onClick={e=>setIsEdit(false)} className='bg-green-100 border border-geen-400 rounded-lg px-4 py-2'>Save</button>
                </>
        ...
        <h2 className='text-xl font-semibold m-4'>Jobs Applied</h2>
        <table className='min-w-full bg-white border rounded-lg'>
            ...
            <tbody>
                {jobsApplied.map((job,index)=> true?(
                    <tr>
                        <td className='p px-4 flex items-center gap-2 border-b'>
